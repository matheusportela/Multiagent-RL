...
# declare this as a publisher of String messages to /pacman/keypress topic
keypress_publisher = rospy.Publisher('/pacman/keypress', String, queue_size=10)
...
#    print event.char, event.keycode
    #publish keypress to /pacman/keypress topic
    keypress_publisher.publish(event.keysym)
    _got_release = None
