...
for i in `seq $NUM_REPETITIONS`
do
  python simulator.py --port $PORT -l $LEARNING_GAMES -t $TESTING_GAMES --pacman-agent eater --ghost-agent ai -e 2 -o $OUTPUT_4/results2_$i.txt -p $OUTPUT_PATH_4/policies2_$i.txt --noise 3
